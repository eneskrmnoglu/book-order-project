        ...
        <div className="relative max-w-xl mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="mt-4 text-lg leading-6 text-gray-500">
              Web sitemizle ilgili yaşadığınız geri bildirimleri duymaktan
              memnuniyet duyarız. Herhangi bir konuda bizimle bu form üzerinden
              ...
              <div className="sm:col-span-2">
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    id="phone-number"
                    autoComplete="tel"
                    className="ml-3 py-3 px-4 block w-full pl-20 focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md"
